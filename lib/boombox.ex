defmodule Boombox do
  ...
  Some encodings can/must be accompanied with encoding specific parameters:
    ...
    * H264:
      - ppss and spss - MAY be provided for RTP input. picture and sequence parameter sets, could be obtained from a side channel. They contain information about the encoded stream.
  """
